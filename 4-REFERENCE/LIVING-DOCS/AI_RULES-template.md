...
At the start of every chat session, before doing anything else, output:
...
Every feature uses exactly 5 chat sessions = 5 GitHub branches:
...
Before closing any chat session, always run this:
