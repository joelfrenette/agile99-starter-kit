# GEMINI.md — Agile99 Project Rules for Google Antigravity
# Place in your project root. Antigravity reads this with highest priority.
# Antigravity also reads AGENTS.md -- keep both in your project root.
